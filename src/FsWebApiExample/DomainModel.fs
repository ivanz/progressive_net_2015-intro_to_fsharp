module FsWebApiExample.DomainModel
...
type DomainMessage =
    ...
    // Validation errors
    // Note: I deliberate choose extremely specific ones to 
...
let createCustomer custId name email extras = 
    {Id = custId; Name = name; Email = email; Extras = extras}

let createExtra key value= 
    {Key = key; Value = value}
